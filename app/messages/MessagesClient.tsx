...
export default function MessagesClient() {
  ...
  useEffect(() => {
    const getSession = async () => {
      ...
      setSession(sess as unknown as UserSession);
  ...
  // NOTE: handleStartConversation is kept for future integrations
  // (e.g. friends list -> open DM)
          ...
          <ul className="flex-1 overflow-y-auto">
            {conversations.map((conv) => (
              <li
                ...
                className={`px-4 py-3 cursor-pointer hover:bg-[#2b2d31] ${
                  selectedConvId === conv.id ? 'bg-[#2b2d31]' : ''
                }`}
              >
                <div className="flex items-center gap-2">
                  ...
                  <div className="flex flex-col min-w-0">
                    <span className="text-sm font-bold text-white truncate">
                      ...
                      {conv.otherUser.migo_tag ? (
                        <span className="text-gray-400">#{conv.otherUser.migo_tag}</span>
                      ) : null}
                    </span>
                  </div>
                </div>
                    ...
                    <div
                      ...
                      className={`max-w-[70%] p-3 rounded-2xl ${
                        mine
                          ...
                          : 'bg-[#2b2d31] text-gray-200 self-start'
                      }`}
                    >
                      {!mine && (
